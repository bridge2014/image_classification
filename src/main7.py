...
print(" --- Optional: Fine-tune (unfreeze last 30 layers for better adaptation)  ----")
...
model.save('resnet50_cancer_classifier7.h5')
...
plt.savefig('accuracy_plot7.png', dpi=150, bbox_inches='tight')
#plt.show()