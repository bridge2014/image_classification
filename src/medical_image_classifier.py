...
def main():
    ...
    # Build model
    classifier.build_model(fine_tune=False)
    ...
    # Train model
    classifier.train(epochs=50, model_save_path='best_resnet50_medical.h5')
    ...
    # Save final model
    classifier.save_model('final_resnet50_medical.h5')
