...
CHECKPOINT_PATH = os.path.join(OUTPUT_DIR, "best_resnet50_copilot.keras")
...
train_ds = tf.keras.utils.image_dataset_from_directory(
    ...
    shuffle=True,
    seed=SEED,
    validation_split=0.2,            # 20% of TRAIN_DIR as validation
    subset="training"
)
...
# Save final model
# =========================================
final_path = os.path.join(OUTPUT_DIR, "resnet50_medical_final.keras")
